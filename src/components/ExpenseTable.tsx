...
import { Plus, Pencil, Trash2, Search, X, RefreshCw, CheckCircle2, Clock, AlertTriangle, DollarSign, ListChecks } from "lucide-react";
        ...
        <Card className="border-0 shadow-lg rounded-2xl">
          <CardHeader className="pb-4">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Button onClick={() => { setEditingExpense(null); setShowForm(true); }} className="gap-2 rounded-xl">
