...
const alertVariants = cva(
  [
    ...
    "bg-card/70 text-foreground backdrop-blur",
    "shadow-sm",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        warning:
          "border-[hsl(var(--warning))]/25 bg-[hsl(var(--warning))]/8 text-foreground [&>svg]:text-[hsl(var(--warning))]",
        success:
          "border-[hsl(var(--success))]/25 bg-[hsl(var(--success))]/8 text-foreground [&>svg]:text-[hsl(var(--success))]",
        destructive:
